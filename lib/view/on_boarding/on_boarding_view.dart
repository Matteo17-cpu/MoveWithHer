...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  List pageArr = [
    ...
    {"title":"Get Burn", "subtitle":"Let’s keep burning, to achive yours goals, it hurts only temporarily, if you give up now you will be in pain forever", "image":"assets/img/on_2.png"},
    ...
    {"title":"Improve Sleep Quality", "subtitle":"Improve the quality of your sleep with us, good quality sleep can bring a good mood in the morning", "image":"assets/img/on_4.png"},
  ];
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index){
              ...
              return OnboardingPageView(p0bj: p0bj);
         },
        ),
             ...
             children: [
              ...
              SizedBox(
               ...
               Container(
                ...
                child: IconButton(icon: Icon( Icons.navigate_next, color: TColor.white, 
                ), 
                onPressed: () {
                  if (selectPage < 3) {
                    ...
                    controller.animateToPage(selectPage, duration: Duration(milliseconds: 600), curve: Curves.bounceInOut);
